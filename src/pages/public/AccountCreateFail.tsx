...
const AccountCreateFail = () => {
    ...
    const deepLinkURL = 'accountcreatefail://account/create/fail'; // Your custom URL scheme
    ...
    return (
        <div style={styles.container}>
            <div style={styles.card}>
                <div style={styles.success}>❌ Account Create Fail!</div>
...
export default AccountCreateFail;
